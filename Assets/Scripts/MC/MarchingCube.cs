...
namespace Voxel {
    ...
    public class MarchingCube {
        ...
        ComputeShader perlin_shader = (ComputeShader)Resources.Load("Perlin");
        ComputeShader mc_shader = (ComputeShader)Resources.Load("MarchingCube");
        ...
        public MarchingCube() {
            ...
            for (int i = 0; i < THREAD_MAX; i++) {
                ...
                trigBuffs[i] = new ComputeBuffer(CHUNK_SIZE * CHUNK_SIZE * CHUNK_SIZE * 12 * 4, 36, ComputeBufferType.Append);
                trigBuffs_PP[i] = new ComputeBuffer(CHUNK_SIZE * CHUNK_SIZE * CHUNK_SIZE * 6, 36, ComputeBufferType.Append);
